...
This document outlines the standard procedure for performing a new release in this project, based on the 0.2.0 release cycle.
...
3.  **Bump Version Numbers**: Increment the version in all sub-component package files:
    *   Python package: `pyproject.toml` (`version` field)
